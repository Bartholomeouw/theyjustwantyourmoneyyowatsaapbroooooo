...
return msg.channel.send(queueembed)
  ...
  if(`${args[0]}` == `loop`){
    if (!msg.member.roles.find("name", "DJ")) return send(msg.channel, "You need **DJ** role for use this command.", {
        name: 'Music Errors',
        icon: 'https://cdn.discordapp.com/avatars/492600047268134912/cfc55222f1e582e3c067aeecb842a2fa.png'
    })
